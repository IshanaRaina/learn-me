...
#this program outputs 2 plots using matplotlib and seaborn based off of a panda's dataframe

import pandas as pd
import seaborn as sns
import matplotlib.pyplot as plt

xl = pd.ExcelFile("Insurance Final 1.xlsx")
df = xl.parse(1)
...
ax = sns.countplot(df["Location Code & Description"], order = df["Location Code & Description"].value_counts().iloc[:10].index)

#rotation of x labels to avoid overlapping
